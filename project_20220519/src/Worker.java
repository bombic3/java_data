...
public class Worker extends People{
	private double basePay; //기본급(월급) -> 월수강비
	private double gradePay; // 직급 별 인센티브 -> 회원등급별 포인트
	private double hourPay; // 시급 -> 시간당 수강비
	private int overHour;	//초과 근무 시간 -> 초과운동시간
	private double nightPay; // 초과근무 수당 -> 초과운동 수강비
	private int nightHour;	//초과 야간 근무 시간 -> 초과 야간 운동 시간
	
	private double totalPay;	//총급여  -> 총 수강료
	private double tax;			//세금   -> 부가세 10%
	private double realPay; //실급여 (실제지급액) -> 실 수강료
